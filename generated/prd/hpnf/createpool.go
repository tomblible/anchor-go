...
func NewCreatePoolInstruction(
	...
	tokenProgram1 ag_solanago.PublicKey) *CreatePool {
...
func NewSimpleCreatePoolInstruction(
	...
	tokenProgram0 ag_solanago.PublicKey,
	tokenProgram1 ag_solanago.PublicKey) *CreatePool {
	poolState := MustFindPoolStateAddress(ammConfig, tokenMint0, tokenMint1)
	tokenVault0 := MustFindTokenVault0Address(poolState, tokenMint0)
	tokenVault1 := MustFindTokenVault1Address(poolState, tokenMint1)
	observationState := MustFindObservationStateAddress(poolState)
	tickArrayBitmap := MustFindTickArrayBitmapAddress(poolState)
	return NewCreatePoolInstructionBuilder().
		SetSqrtPriceX64(sqrt_price_x64).
		SetOpenTime(open_time).
		SetPoolCreatorAccount(poolCreator).
