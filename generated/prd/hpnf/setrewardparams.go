...
func NewSetRewardParamsInstructionBuilder() *SetRewardParams {
	...
	nd.AccountMetaSlice[3] = ag_solanago.Meta(OperationStatePDA)
	nd.AccountMetaSlice[4] = ag_solanago.Meta(TokenProgram)
	nd.AccountMetaSlice[5] = ag_solanago.Meta(Token22Program)
	return nd
}
...
func NewSetRewardParamsInstruction(
	...
	poolState ag_solanago.PublicKey) *SetRewardParams {
