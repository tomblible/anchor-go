...
func NewCollectRemainingRewardsInstructionBuilder() *CollectRemainingRewards {
	...
	nd.AccountMetaSlice[5] = ag_solanago.Meta(TokenProgram)
	nd.AccountMetaSlice[6] = ag_solanago.Meta(Token22Program)
	nd.AccountMetaSlice[7] = ag_solanago.Meta(MemoProgram)
	return nd
}
...
func (inst *CollectRemainingRewards) SetAccounts(accounts []*ag_solanago.AccountMeta) error {
	inst.AccountMetaSlice = accounts
	return inst.Validate()
}

func (inst *CollectRemainingRewards) SetRemainingAccounts(metas []*ag_solanago.AccountMeta) *CollectRemainingRewards {
	inst.AccountMetaSlice = append(inst.AccountMetaSlice[0:8], metas...)
	return inst
}

func (inst *CollectRemainingRewards) GetRemainingAccounts() []*ag_solanago.AccountMeta {
...
func NewCollectRemainingRewardsInstruction(
	...
	rewardVaultMint ag_solanago.PublicKey) *CollectRemainingRewards {
...
// NewSimpleCollectRemainingRewardsInstruction declares a new CollectRemainingRewards instruction with the provided parameters and accounts.
func NewSimpleCollectRemainingRewardsInstruction(
	// Parameters:
	reward_index uint8,
	// Accounts:
	rewardFunder ag_solanago.PublicKey,
