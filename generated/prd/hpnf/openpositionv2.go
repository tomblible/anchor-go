...
func NewOpenPositionV2InstructionBuilder() *OpenPositionV2 {
	...
	nd.AccountMetaSlice[14] = ag_solanago.Meta(RentProgram)
	nd.AccountMetaSlice[15] = ag_solanago.Meta(SystemProgram)
	nd.AccountMetaSlice[16] = ag_solanago.Meta(TokenProgram)
	nd.AccountMetaSlice[17] = ag_solanago.Meta(AssociatedTokenProgram)
	nd.AccountMetaSlice[18] = ag_solanago.Meta(TokenMetadataProgram)
