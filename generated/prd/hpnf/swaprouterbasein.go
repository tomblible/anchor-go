...
func NewSwapRouterBaseInInstructionBuilder() *SwapRouterBaseIn {
	...
	nd.AccountMetaSlice[3] = ag_solanago.Meta(TokenProgram)
	nd.AccountMetaSlice[4] = ag_solanago.Meta(Token22Program)
	nd.AccountMetaSlice[5] = ag_solanago.Meta(MemoProgram)
	return nd
}
...
func NewSwapRouterBaseInInstruction(
	...
	inputTokenMint ag_solanago.PublicKey) *SwapRouterBaseIn {
