...
// NewPartnerWithdrawSurplusInstructionBuilder creates a new `PartnerWithdrawSurplus` instruction builder.
func NewPartnerWithdrawSurplusInstructionBuilder() *PartnerWithdrawSurplus {
	nd := &PartnerWithdrawSurplus{
...
func (inst *PartnerWithdrawSurplus) SetPoolAuthorityAccount(poolAuthority ag_solanago.PublicKey) *PartnerWithdrawSurplus {
	inst.AccountMetaSlice[0] = ag_solanago.Meta(poolAuthority)
	return inst
}

// GetPoolAuthorityAccount gets the "pool_authority" account.
func (inst *PartnerWithdrawSurplus) GetPoolAuthorityAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(0)
}

// SetConfigAccount sets the "config" account.
func (inst *PartnerWithdrawSurplus) SetConfigAccount(config ag_solanago.PublicKey) *PartnerWithdrawSurplus {
	inst.AccountMetaSlice[1] = ag_solanago.Meta(config)
	return inst
}

// GetConfigAccount gets the "config" account.
func (inst *PartnerWithdrawSurplus) GetConfigAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(1)
}

// SetVirtualPoolAccount sets the "virtual_pool" account.
func (inst *PartnerWithdrawSurplus) SetVirtualPoolAccount(virtualPool ag_solanago.PublicKey) *PartnerWithdrawSurplus {
	inst.AccountMetaSlice[2] = ag_solanago.Meta(virtualPool).WRITE()
	return inst
}

// GetVirtualPoolAccount gets the "virtual_pool" account.
func (inst *PartnerWithdrawSurplus) GetVirtualPoolAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(2)
}

// SetTokenQuoteAccountAccount sets the "token_quote_account" account.
// The receiver token account
func (inst *PartnerWithdrawSurplus) SetTokenQuoteAccountAccount(tokenQuoteAccount ag_solanago.PublicKey) *PartnerWithdrawSurplus {
...
// The receiver token account
func (inst *PartnerWithdrawSurplus) GetTokenQuoteAccountAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(3)
}

// SetQuoteVaultAccount sets the "quote_vault" account.
// The vault token account for output token
func (inst *PartnerWithdrawSurplus) SetQuoteVaultAccount(quoteVault ag_solanago.PublicKey) *PartnerWithdrawSurplus {
...
// The vault token account for output token
func (inst *PartnerWithdrawSurplus) GetQuoteVaultAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(4)
}

// SetQuoteMintAccount sets the "quote_mint" account.
// The mint of quote token
func (inst *PartnerWithdrawSurplus) SetQuoteMintAccount(quoteMint ag_solanago.PublicKey) *PartnerWithdrawSurplus {
...
// The mint of quote token
func (inst *PartnerWithdrawSurplus) GetQuoteMintAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(5)
}

// SetFeeClaimerAccount sets the "fee_claimer" account.
func (inst *PartnerWithdrawSurplus) SetFeeClaimerAccount(feeClaimer ag_solanago.PublicKey) *PartnerWithdrawSurplus {
	inst.AccountMetaSlice[6] = ag_solanago.Meta(feeClaimer).SIGNER()
	return inst
}

// GetFeeClaimerAccount gets the "fee_claimer" account.
func (inst *PartnerWithdrawSurplus) GetFeeClaimerAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(6)
}

// SetTokenQuoteProgramAccount sets the "token_quote_program" account.
// Token b program
func (inst *PartnerWithdrawSurplus) SetTokenQuoteProgramAccount(tokenQuoteProgram ag_solanago.PublicKey) *PartnerWithdrawSurplus {
...
// Token b program
func (inst *PartnerWithdrawSurplus) GetTokenQuoteProgramAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(7)
}

// SetEventAuthorityAccount sets the "event_authority" account.
func (inst *PartnerWithdrawSurplus) SetEventAuthorityAccount(eventAuthority ag_solanago.PublicKey) *PartnerWithdrawSurplus {
	inst.AccountMetaSlice[8] = ag_solanago.Meta(eventAuthority)
	return inst
}

// GetEventAuthorityAccount gets the "event_authority" account.
func (inst *PartnerWithdrawSurplus) GetEventAuthorityAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(8)
}

// SetProgramAccount sets the "program" account.
func (inst *PartnerWithdrawSurplus) SetProgramAccount(program ag_solanago.PublicKey) *PartnerWithdrawSurplus {
	inst.AccountMetaSlice[9] = ag_solanago.Meta(program)
	return inst
}

// GetProgramAccount gets the "program" account.
func (inst *PartnerWithdrawSurplus) GetProgramAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(9)
}

func (inst *PartnerWithdrawSurplus) SetAccounts(accounts []*ag_solanago.AccountMeta) error {
	inst.AccountMetaSlice = accounts
	return inst.Validate()
}

func (inst *PartnerWithdrawSurplus) SetRemainingAccounts(metas []*ag_solanago.AccountMeta) *PartnerWithdrawSurplus {
	inst.AccountMetaSlice = append(inst.AccountMetaSlice[0:10], metas...)
	return inst
}

func (inst *PartnerWithdrawSurplus) GetRemainingAccounts() []*ag_solanago.AccountMeta {
	return inst.AccountMetaSlice[10:]
}

func (inst PartnerWithdrawSurplus) Build() *Instruction {
...
func (inst PartnerWithdrawSurplus) ValidateAndBuild() (*Instruction, error) {
...
func (inst *PartnerWithdrawSurplus) Validate() error {
...
func (inst *PartnerWithdrawSurplus) EncodeToTree(parent ag_treeout.Branches) {
...
func (obj PartnerWithdrawSurplus) MarshalWithEncoder(encoder *ag_binary.Encoder) (err error) {
	return nil
}
func (obj *PartnerWithdrawSurplus) UnmarshalWithDecoder(decoder *ag_binary.Decoder) (err error) {
	return nil
}
...
func NewSimplePartnerWithdrawSurplusInstruction(
	config ag_solanago.PublicKey,
	virtualPool ag_solanago.PublicKey,
	tokenQuoteAccount ag_solanago.PublicKey,
	quoteVault ag_solanago.PublicKey,
