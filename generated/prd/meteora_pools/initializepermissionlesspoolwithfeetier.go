...
func (inst *InitializePermissionlessPoolWithFeeTier) SetCurveType(curve_type CurveType) *InitializePermissionlessPoolWithFeeTier {
	inst.CurveType = curve_type
	return inst
}

// SetTradeFeeBps sets the "trade_fee_bps" parameter.
func (inst *InitializePermissionlessPoolWithFeeTier) SetTradeFeeBps(trade_fee_bps uint64) *InitializePermissionlessPoolWithFeeTier {
	inst.TradeFeeBps = &trade_fee_bps
	return inst
}

// SetTokenAAmount sets the "token_a_amount" parameter.
func (inst *InitializePermissionlessPoolWithFeeTier) SetTokenAAmount(token_a_amount uint64) *InitializePermissionlessPoolWithFeeTier {
	inst.TokenAAmount = &token_a_amount
	return inst
}

// SetTokenBAmount sets the "token_b_amount" parameter.
func (inst *InitializePermissionlessPoolWithFeeTier) SetTokenBAmount(token_b_amount uint64) *InitializePermissionlessPoolWithFeeTier {
...
func (inst *InitializePermissionlessPoolWithFeeTier) SetAccounts(accounts []*ag_solanago.AccountMeta) error {
	inst.AccountMetaSlice = accounts
	return inst.Validate()
}

func (inst *InitializePermissionlessPoolWithFeeTier) SetRemainingAccounts(metas []*ag_solanago.AccountMeta) *InitializePermissionlessPoolWithFeeTier {
	inst.AccountMetaSlice = append(inst.AccountMetaSlice[0:26], metas...)
	return inst
}

func (inst *InitializePermissionlessPoolWithFeeTier) GetRemainingAccounts() []*ag_solanago.AccountMeta {
...
// NewSimpleInitializePermissionlessPoolWithFeeTierInstruction declares a new InitializePermissionlessPoolWithFeeTier instruction with the provided parameters and accounts.
func NewSimpleInitializePermissionlessPoolWithFeeTierInstruction(
	// Parameters:
	curve_type CurveType,
	trade_fee_bps uint64,
	token_a_amount uint64,
