			...
			programBranch.Child(ag_format.Instruction("UpdateFeesAndRewards")).
				...
				ParentFunc(func(instructionBranch ag_treeout.Branches) {
					...
					instructionBranch.Child("Accounts[len=4]").ParentFunc(func(accountsBranch ag_treeout.Branches) {
						...
						accountsBranch.Child(ag_format.Meta("tick_array_lower", inst.AccountMetaSlice.Get(2)))
						accountsBranch.Child(ag_format.Meta("tick_array_upper", inst.AccountMetaSlice.Get(3)))
					})
				})
		})
}
