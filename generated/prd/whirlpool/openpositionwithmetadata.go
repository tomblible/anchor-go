...
// OpenPositionWithMetadata is the `open_position_with_metadata` instruction.
type OpenPositionWithMetadata struct {
	...
	//
	// [4] = [WRITE] position_metadata_account
	//
	// [5] = [WRITE] position_token_account
	//
	// [6] = [] whirlpool
	//
	// [7] = [] token_program
...
func (inst *OpenPositionWithMetadata) SetTickLowerIndex(tick_lower_index int32) *OpenPositionWithMetadata {
	inst.TickLowerIndex = &tick_lower_index
	return inst
}

// SetTickUpperIndex sets the "tick_upper_index" parameter.
func (inst *OpenPositionWithMetadata) SetTickUpperIndex(tick_upper_index int32) *OpenPositionWithMetadata {
...
// SetPositionMetadataAccountAccount sets the "position_metadata_account" account.
...
// GetPositionMetadataAccountAccount gets the "position_metadata_account" account.
...
func (inst *OpenPositionWithMetadata) SetAccounts(accounts []*ag_solanago.AccountMeta) error {
	inst.AccountMetaSlice = accounts
	return inst.Validate()
}

func (inst *OpenPositionWithMetadata) SetRemainingAccounts(metas []*ag_solanago.AccountMeta) *OpenPositionWithMetadata {
	inst.AccountMetaSlice = append(inst.AccountMetaSlice[0:13], metas...)
	return inst
}

func (inst *OpenPositionWithMetadata) GetRemainingAccounts() []*ag_solanago.AccountMeta {
			...
			programBranch.Child(ag_format.Instruction("OpenPositionWithMetadata")).
				...
				ParentFunc(func(instructionBranch ag_treeout.Branches) {
					...
					instructionBranch.Child("Accounts[len=13]").ParentFunc(func(accountsBranch ag_treeout.Branches) {
						...
						accountsBranch.Child(ag_format.Meta("      position_metadata_", inst.AccountMetaSlice.Get(4)))
						accountsBranch.Child(ag_format.Meta("         position_token_", inst.AccountMetaSlice.Get(5)))
						...
						accountsBranch.Child(ag_format.Meta("    metadata_update_auth", inst.AccountMetaSlice.Get(12)))
					})
				})
		})
}
...
// NewSimpleOpenPositionWithMetadataInstruction declares a new OpenPositionWithMetadata instruction with the provided parameters and accounts.
func NewSimpleOpenPositionWithMetadataInstruction(
	// Parameters:
	bumps OpenPositionWithMetadataBumps,
	tick_lower_index int32,
	tick_upper_index int32,
