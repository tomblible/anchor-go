...
var AdaptiveFeeTierAccountDiscriminator = [8]byte{147, 16, 144, 116, 47, 146, 149, 46}

func (obj AdaptiveFeeTierAccount) MarshalWithEncoder(encoder *ag_binary.Encoder) (err error) {
	// Write account discriminator:
	err = encoder.WriteBytes(AdaptiveFeeTierAccountDiscriminator[:], false)
	if err != nil {
		return err
	}
...
func (obj *AdaptiveFeeTierAccount) UnmarshalWithDecoder(decoder *ag_binary.Decoder) (err error) {
	// Read and check account discriminator:
	{
		...
		if !discriminator.Equal(AdaptiveFeeTierAccountDiscriminator[:]) {
			return fmt.Errorf(
...
type WhirlpoolsConfigExtensionAccount struct {
	WhirlpoolsConfig         ag_solanago.PublicKey
	ConfigExtensionAuthority ag_solanago.PublicKey
	TokenBadgeAuthority      ag_solanago.PublicKey
}

var WhirlpoolsConfigExtensionAccountDiscriminator = [8]byte{2, 99, 215, 163, 240, 26, 153, 58}

func (obj WhirlpoolsConfigExtensionAccount) MarshalWithEncoder(encoder *ag_binary.Encoder) (err error) {
	// Write account discriminator:
	err = encoder.WriteBytes(WhirlpoolsConfigExtensionAccountDiscriminator[:], false)
	if err != nil {
		return err
	}
	// Serialize `WhirlpoolsConfig` param:
...
func (obj *WhirlpoolsConfigExtensionAccount) UnmarshalWithDecoder(decoder *ag_binary.Decoder) (err error) {
	// Read and check account discriminator:
	{
		discriminator, err := decoder.ReadTypeID()
		if err != nil {
		...
		if !discriminator.Equal(WhirlpoolsConfigExtensionAccountDiscriminator[:]) {
			return fmt.Errorf(
				"wrong discriminator: wanted %s, got %s",
...
type WhirlpoolsConfigAccount struct {
...
var WhirlpoolsConfigAccountDiscriminator = [8]byte{157, 20, 49, 224, 217, 87, 193, 254}

func (obj WhirlpoolsConfigAccount) MarshalWithEncoder(encoder *ag_binary.Encoder) (err error) {
	// Write account discriminator:
	err = encoder.WriteBytes(WhirlpoolsConfigAccountDiscriminator[:], false)
	if err != nil {
		return err
	}
...
func (obj *WhirlpoolsConfigAccount) UnmarshalWithDecoder(decoder *ag_binary.Decoder) (err error) {
	// Read and check account discriminator:
	{
		discriminator, err := decoder.ReadTypeID()
		if err != nil {
		...
		if !discriminator.Equal(WhirlpoolsConfigAccountDiscriminator[:]) {
			return fmt.Errorf(
				"wrong discriminator: wanted %s, got %s",
...
var FeeTierAccountDiscriminator = [8]byte{56, 75, 159, 76, 142, 68, 190, 105}

func (obj FeeTierAccount) MarshalWithEncoder(encoder *ag_binary.Encoder) (err error) {
	// Write account discriminator:
	err = encoder.WriteBytes(FeeTierAccountDiscriminator[:], false)
	if err != nil {
		return err
	}
	// Serialize `WhirlpoolsConfig` param:
...
func (obj *FeeTierAccount) UnmarshalWithDecoder(decoder *ag_binary.Decoder) (err error) {
	// Read and check account discriminator:
	{
		discriminator, err := decoder.ReadTypeID()
		if err != nil {
		...
		if !discriminator.Equal(FeeTierAccountDiscriminator[:]) {
			return fmt.Errorf(
				"wrong discriminator: wanted %s, got %s",
...
var LockConfigAccountDiscriminator = [8]byte{106, 47, 238, 159, 124, 12, 160, 192}

func (obj LockConfigAccount) MarshalWithEncoder(encoder *ag_binary.Encoder) (err error) {
	// Write account discriminator:
	err = encoder.WriteBytes(LockConfigAccountDiscriminator[:], false)
	if err != nil {
		return err
	}
...
func (obj *LockConfigAccount) UnmarshalWithDecoder(decoder *ag_binary.Decoder) (err error) {
	// Read and check account discriminator:
	{
		discriminator, err := decoder.ReadTypeID()
		if err != nil {
		...
		if !discriminator.Equal(LockConfigAccountDiscriminator[:]) {
			return fmt.Errorf(
				"wrong discriminator: wanted %s, got %s",
...
type PositionBundleAccount struct {
	PositionBundleMint ag_solanago.PublicKey
	PositionBitmap     [32]uint8
}

var PositionBundleAccountDiscriminator = [8]byte{129, 169, 175, 65, 185, 95, 32, 100}

func (obj PositionBundleAccount) MarshalWithEncoder(encoder *ag_binary.Encoder) (err error) {
	// Write account discriminator:
	err = encoder.WriteBytes(PositionBundleAccountDiscriminator[:], false)
	if err != nil {
		return err
	}
...
func (obj *PositionBundleAccount) UnmarshalWithDecoder(decoder *ag_binary.Decoder) (err error) {
	// Read and check account discriminator:
	{
		discriminator, err := decoder.ReadTypeID()
		if err != nil {
		...
		if !discriminator.Equal(PositionBundleAccountDiscriminator[:]) {
			return fmt.Errorf(
				"wrong discriminator: wanted %s, got %s",
...
var TickArrayAccountDiscriminator = [8]byte{69, 97, 189, 190, 110, 7, 66, 187}

func (obj TickArrayAccount) MarshalWithEncoder(encoder *ag_binary.Encoder) (err error) {
	// Write account discriminator:
	err = encoder.WriteBytes(TickArrayAccountDiscriminator[:], false)
	if err != nil {
		return err
	}
...
func (obj *TickArrayAccount) UnmarshalWithDecoder(decoder *ag_binary.Decoder) (err error) {
	// Read and check account discriminator:
	{
		discriminator, err := decoder.ReadTypeID()
		if err != nil {
		...
		if !discriminator.Equal(TickArrayAccountDiscriminator[:]) {
			return fmt.Errorf(
				"wrong discriminator: wanted %s, got %s",
...
var WhirlpoolAccountDiscriminator = [8]byte{63, 149, 209, 12, 225, 128, 99, 9}

func (obj WhirlpoolAccount) MarshalWithEncoder(encoder *ag_binary.Encoder) (err error) {
	// Write account discriminator:
	err = encoder.WriteBytes(WhirlpoolAccountDiscriminator[:], false)
	if err != nil {
		return err
	}
	// Serialize `WhirlpoolsConfig` param:
...
func (obj *WhirlpoolAccount) UnmarshalWithDecoder(decoder *ag_binary.Decoder) (err error) {
	// Read and check account discriminator:
	{
		discriminator, err := decoder.ReadTypeID()
		if err != nil {
		...
		if !discriminator.Equal(WhirlpoolAccountDiscriminator[:]) {
			return fmt.Errorf(
				"wrong discriminator: wanted %s, got %s",
