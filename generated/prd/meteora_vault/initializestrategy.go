...
func (inst *InitializeStrategy) SetStrategyType(strategy_type StrategyType) *InitializeStrategy {
...
func (inst *InitializeStrategy) SetAccounts(accounts []*ag_solanago.AccountMeta) error {
	inst.AccountMetaSlice = accounts
	return inst.Validate()
}

func (inst *InitializeStrategy) SetRemainingAccounts(metas []*ag_solanago.AccountMeta) *InitializeStrategy {
	inst.AccountMetaSlice = append(inst.AccountMetaSlice[0:10], metas...)
	return inst
}

func (inst *InitializeStrategy) GetRemainingAccounts() []*ag_solanago.AccountMeta {
...
// NewSimpleInitializeStrategyInstruction declares a new InitializeStrategy instruction with the provided parameters and accounts.
func NewSimpleInitializeStrategyInstruction(
	// Parameters:
	bumps StrategyBumps,
	strategy_type StrategyType,
	// Accounts:
