...
func (inst *Withdraw2) SetUnmintAmount(unmint_amount uint64) *Withdraw2 {
	inst.UnmintAmount = &unmint_amount
	return inst
}

// SetMinOutAmount sets the "min_out_amount" parameter.
func (inst *Withdraw2) SetMinOutAmount(min_out_amount uint64) *Withdraw2 {
...
func (inst *Withdraw2) SetAccounts(accounts []*ag_solanago.AccountMeta) error {
	inst.AccountMetaSlice = accounts
	return inst.Validate()
}

func (inst *Withdraw2) SetRemainingAccounts(metas []*ag_solanago.AccountMeta) *Withdraw2 {
	inst.AccountMetaSlice = append(inst.AccountMetaSlice[0:7], metas...)
	return inst
}

func (inst *Withdraw2) GetRemainingAccounts() []*ag_solanago.AccountMeta {
...
// NewSimpleWithdraw2Instruction declares a new Withdraw2 instruction with the provided parameters and accounts.
func NewSimpleWithdraw2Instruction(
	// Parameters:
	unmint_amount uint64,
	min_out_amount uint64,
	// Accounts:
