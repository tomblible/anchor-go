...
func (inst *CollectDust) SetAccounts(accounts []*ag_solanago.AccountMeta) error {
	inst.AccountMetaSlice = accounts
	return inst.Validate()
}

func (inst *CollectDust) SetRemainingAccounts(metas []*ag_solanago.AccountMeta) *CollectDust {
	inst.AccountMetaSlice = append(inst.AccountMetaSlice[0:5], metas...)
	return inst
}

func (inst *CollectDust) GetRemainingAccounts() []*ag_solanago.AccountMeta {
...
// NewSimpleCollectDustInstruction declares a new CollectDust instruction with the provided parameters and accounts.
func NewSimpleCollectDustInstruction(
	// Accounts:
	vault ag_solanago.PublicKey,
	tokenVault ag_solanago.PublicKey,
	tokenAdmin ag_solanago.PublicKey,
