...
func (inst *RemoveStrategy2) SetMaxAdminPayAmount(max_admin_pay_amount uint64) *RemoveStrategy2 {
...
func (inst *RemoveStrategy2) SetAccounts(accounts []*ag_solanago.AccountMeta) error {
	inst.AccountMetaSlice = accounts
	return inst.Validate()
}

func (inst *RemoveStrategy2) SetRemainingAccounts(metas []*ag_solanago.AccountMeta) *RemoveStrategy2 {
	inst.AccountMetaSlice = append(inst.AccountMetaSlice[0:12], metas...)
	return inst
}

func (inst *RemoveStrategy2) GetRemainingAccounts() []*ag_solanago.AccountMeta {
...
// NewSimpleRemoveStrategy2Instruction declares a new RemoveStrategy2 instruction with the provided parameters and accounts.
func NewSimpleRemoveStrategy2Instruction(
	// Parameters:
	max_admin_pay_amount uint64,
	// Accounts:
	vault ag_solanago.PublicKey,
