...
func (inst *WithdrawStrategy) SetAccounts(accounts []*ag_solanago.AccountMeta) error {
	inst.AccountMetaSlice = accounts
	return inst.Validate()
}

func (inst *WithdrawStrategy) SetRemainingAccounts(metas []*ag_solanago.AccountMeta) *WithdrawStrategy {
	inst.AccountMetaSlice = append(inst.AccountMetaSlice[0:10], metas...)
	return inst
}

func (inst *WithdrawStrategy) GetRemainingAccounts() []*ag_solanago.AccountMeta {
...
// NewSimpleWithdrawStrategyInstruction declares a new WithdrawStrategy instruction with the provided parameters and accounts.
func NewSimpleWithdrawStrategyInstruction(
	// Parameters:
	amount uint64,
	// Accounts:
	vault ag_solanago.PublicKey,
