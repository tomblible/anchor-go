...
func (inst *InitializeReward) SetSignerAccount(signer ag_solanago.PublicKey) *InitializeReward {
	inst.AccountMetaSlice[4] = ag_solanago.Meta(signer).SIGNER()
	return inst
}

// GetSignerAccount gets the "signer" account.
func (inst *InitializeReward) GetSignerAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(4)
}

// SetPayerAccount sets the "payer" account.
func (inst *InitializeReward) SetPayerAccount(payer ag_solanago.PublicKey) *InitializeReward {
	inst.AccountMetaSlice[5] = ag_solanago.Meta(payer).WRITE().SIGNER()
	return inst
}

// GetPayerAccount gets the "payer" account.
func (inst *InitializeReward) GetPayerAccount() *ag_solanago.AccountMeta {
