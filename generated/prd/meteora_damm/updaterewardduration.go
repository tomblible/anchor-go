...
func (inst *UpdateRewardDuration) SetSignerAccount(signer ag_solanago.PublicKey) *UpdateRewardDuration {
	inst.AccountMetaSlice[1] = ag_solanago.Meta(signer).SIGNER()
	return inst
}

// GetSignerAccount gets the "signer" account.
func (inst *UpdateRewardDuration) GetSignerAccount() *ag_solanago.AccountMeta {
...
func NewUpdateRewardDurationInstruction(
	...
	signer ag_solanago.PublicKey) *UpdateRewardDuration {
