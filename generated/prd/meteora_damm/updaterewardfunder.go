...
func (inst *UpdateRewardFunder) SetSignerAccount(signer ag_solanago.PublicKey) *UpdateRewardFunder {
	inst.AccountMetaSlice[1] = ag_solanago.Meta(signer).SIGNER()
	return inst
}

// GetSignerAccount gets the "signer" account.
func (inst *UpdateRewardFunder) GetSignerAccount() *ag_solanago.AccountMeta {
...
func NewUpdateRewardFunderInstruction(
	...
	signer ag_solanago.PublicKey) *UpdateRewardFunder {
