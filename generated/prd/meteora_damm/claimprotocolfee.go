...
func (inst *ClaimProtocolFee) SetMaxAmountA(max_amount_a uint64) *ClaimProtocolFee {
	inst.MaxAmountA = &max_amount_a
	return inst
}

// SetMaxAmountB sets the "max_amount_b" parameter.
func (inst *ClaimProtocolFee) SetMaxAmountB(max_amount_b uint64) *ClaimProtocolFee {
