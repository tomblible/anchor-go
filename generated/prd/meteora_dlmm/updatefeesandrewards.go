...
// UpdateFeesAndRewards is the `update_fees_and_rewards` instruction.
...
func (inst *UpdateFeesAndRewards) SetAccounts(accounts []*ag_solanago.AccountMeta) error {
	inst.AccountMetaSlice = accounts
	return inst.Validate()
}

func (inst *UpdateFeesAndRewards) SetRemainingAccounts(metas []*ag_solanago.AccountMeta) *UpdateFeesAndRewards {
	inst.AccountMetaSlice = append(inst.AccountMetaSlice[0:5], metas...)
	return inst
}

func (inst *UpdateFeesAndRewards) GetRemainingAccounts() []*ag_solanago.AccountMeta {
...
// NewSimpleUpdateFeesAndRewardsInstruction declares a new UpdateFeesAndRewards instruction with the provided parameters and accounts.
func NewSimpleUpdateFeesAndRewardsInstruction(
	// Accounts:
	position ag_solanago.PublicKey,
	lbPair ag_solanago.PublicKey,
	binArrayLower ag_solanago.PublicKey,
