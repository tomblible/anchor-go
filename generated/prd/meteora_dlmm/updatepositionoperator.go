...
// UpdatePositionOperator is the `update_position_operator` instruction.
...
func (inst *UpdatePositionOperator) SetAccounts(accounts []*ag_solanago.AccountMeta) error {
	inst.AccountMetaSlice = accounts
	return inst.Validate()
}

func (inst *UpdatePositionOperator) SetRemainingAccounts(metas []*ag_solanago.AccountMeta) *UpdatePositionOperator {
	inst.AccountMetaSlice = append(inst.AccountMetaSlice[0:4], metas...)
	return inst
}

func (inst *UpdatePositionOperator) GetRemainingAccounts() []*ag_solanago.AccountMeta {
...
func NewUpdatePositionOperatorInstruction(
	...
	eventAuthority ag_solanago.PublicKey) *UpdatePositionOperator {
...
// NewSimpleUpdatePositionOperatorInstruction declares a new UpdatePositionOperator instruction with the provided parameters and accounts.
func NewSimpleUpdatePositionOperatorInstruction(
	// Parameters:
	operator ag_solanago.PublicKey,
	// Accounts:
	position ag_solanago.PublicKey,
