...
func (inst *InitializeReward) SetRewardIndex(reward_index uint64) *InitializeReward {
...
// GetTokenBadgeAccount gets the "token_badge" account (optional).
			...
			programBranch.Child(ag_format.Instruction("InitializeReward")).
				...
				ParentFunc(func(instructionBranch ag_treeout.Branches) {
					...
					instructionBranch.Child("Accounts[len=10]").ParentFunc(func(accountsBranch ag_treeout.Branches) {
						...
						accountsBranch.Child(ag_format.Meta("    token_badge", inst.AccountMetaSlice.Get(3)))
