...
// AddLiquidityByStrategyOneSide is the `add_liquidity_by_strategy_one_side` instruction.
...
func (inst *AddLiquidityByStrategyOneSide) SetLiquidityParameter(liquidity_parameter LiquidityParameterByStrategyOneSide) *AddLiquidityByStrategyOneSide {
...
func (inst *AddLiquidityByStrategyOneSide) SetAccounts(accounts []*ag_solanago.AccountMeta) error {
	inst.AccountMetaSlice = accounts
	return inst.Validate()
}

func (inst *AddLiquidityByStrategyOneSide) SetRemainingAccounts(metas []*ag_solanago.AccountMeta) *AddLiquidityByStrategyOneSide {
	inst.AccountMetaSlice = append(inst.AccountMetaSlice[0:12], metas...)
	return inst
}

func (inst *AddLiquidityByStrategyOneSide) GetRemainingAccounts() []*ag_solanago.AccountMeta {
...
func NewAddLiquidityByStrategyOneSideInstruction(
	...
	eventAuthority ag_solanago.PublicKey) *AddLiquidityByStrategyOneSide {
...
// NewSimpleAddLiquidityByStrategyOneSideInstruction declares a new AddLiquidityByStrategyOneSide instruction with the provided parameters and accounts.
func NewSimpleAddLiquidityByStrategyOneSideInstruction(
	// Parameters:
	liquidity_parameter LiquidityParameterByStrategyOneSide,
	// Accounts:
	position ag_solanago.PublicKey,
