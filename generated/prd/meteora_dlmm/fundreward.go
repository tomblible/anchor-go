...
func (inst *FundReward) SetRewardIndex(reward_index uint64) *FundReward {
...
func (inst *FundReward) SetRemainingAccountsInfo(remaining_accounts_info RemainingAccountsInfo) *FundReward {
