...
func (inst *ClaimVestedToken) SetAccounts(accounts []*ag_solanago.AccountMeta) error {
	inst.AccountMetaSlice = accounts
	return inst.Validate()
}

func (inst *ClaimVestedToken) SetRemainingAccounts(metas []*ag_solanago.AccountMeta) *ClaimVestedToken {
	inst.AccountMetaSlice = append(inst.AccountMetaSlice[0:10], metas...)
	return inst
}

func (inst *ClaimVestedToken) GetRemainingAccounts() []*ag_solanago.AccountMeta {
...
func NewClaimVestedTokenInstruction(
	...
	baseTokenMint ag_solanago.PublicKey) *ClaimVestedToken {
...
// NewSimpleClaimVestedTokenInstruction declares a new ClaimVestedToken instruction with the provided parameters and accounts.
func NewSimpleClaimVestedTokenInstruction(
	// Accounts:
	beneficiary ag_solanago.PublicKey,
	poolState ag_solanago.PublicKey,
	baseVault ag_solanago.PublicKey,
