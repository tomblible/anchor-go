...
func (inst *CollectMigrateFee) SetAccounts(accounts []*ag_solanago.AccountMeta) error {
	inst.AccountMetaSlice = accounts
	return inst.Validate()
}

func (inst *CollectMigrateFee) SetRemainingAccounts(metas []*ag_solanago.AccountMeta) *CollectMigrateFee {
	inst.AccountMetaSlice = append(inst.AccountMetaSlice[0:8], metas...)
	return inst
}

func (inst *CollectMigrateFee) GetRemainingAccounts() []*ag_solanago.AccountMeta {
...
func NewCollectMigrateFeeInstruction(
	...
	recipientTokenAccount ag_solanago.PublicKey) *CollectMigrateFee {
...
// NewSimpleCollectMigrateFeeInstruction declares a new CollectMigrateFee instruction with the provided parameters and accounts.
func NewSimpleCollectMigrateFeeInstruction(
	// Accounts:
	owner ag_solanago.PublicKey,
	poolState ag_solanago.PublicKey,
	globalConfig ag_solanago.PublicKey,
