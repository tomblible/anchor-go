...
func (inst *UpdateConfig) SetAccounts(accounts []*ag_solanago.AccountMeta) error {
	inst.AccountMetaSlice = accounts
	return inst.Validate()
}

func (inst *UpdateConfig) SetRemainingAccounts(metas []*ag_solanago.AccountMeta) *UpdateConfig {
	inst.AccountMetaSlice = append(inst.AccountMetaSlice[0:2], metas...)
	return inst
}

func (inst *UpdateConfig) GetRemainingAccounts() []*ag_solanago.AccountMeta {
...
// NewSimpleUpdateConfigInstruction declares a new UpdateConfig instruction with the provided parameters and accounts.
func NewSimpleUpdateConfigInstruction(
	// Parameters:
	param uint8,
	value uint64,
	globalConfig ag_solanago.PublicKey) *UpdateConfig {
