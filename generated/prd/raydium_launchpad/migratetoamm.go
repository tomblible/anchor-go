...
func NewMigrateToAmmInstructionBuilder() *MigrateToAmm {
	...
	nd.AccountMetaSlice[3] = ag_solanago.Meta(SerumDexProgram)
	nd.AccountMetaSlice[12] = ag_solanago.Meta(RaydiumAmmV4Program)
	nd.AccountMetaSlice[22] = ag_solanago.Meta(AuthorityPDA).WRITE()
	nd.AccountMetaSlice[28] = ag_solanago.Meta(TokenProgram)
	nd.AccountMetaSlice[29] = ag_solanago.Meta(AssociatedTokenProgram)
	nd.AccountMetaSlice[30] = ag_solanago.Meta(SystemProgram)
	nd.AccountMetaSlice[31] = ag_solanago.Meta(RentProgram)
	return nd
}
...
func (inst *MigrateToAmm) SetAccounts(accounts []*ag_solanago.AccountMeta) error {
	inst.AccountMetaSlice = accounts
	return inst.Validate()
}

func (inst *MigrateToAmm) SetRemainingAccounts(metas []*ag_solanago.AccountMeta) *MigrateToAmm {
	inst.AccountMetaSlice = append(inst.AccountMetaSlice[0:32], metas...)
	return inst
}

func (inst *MigrateToAmm) GetRemainingAccounts() []*ag_solanago.AccountMeta {
	return inst.AccountMetaSlice[32:]
}
...
func NewMigrateToAmmInstruction(
	...
	poolLpToken ag_solanago.PublicKey) *MigrateToAmm {
...
// NewSimpleMigrateToAmmInstruction declares a new MigrateToAmm instruction with the provided parameters and accounts.
func NewSimpleMigrateToAmmInstruction(
	// Parameters:
	base_lot_size uint64,
	quote_lot_size uint64,
	market_vault_signer_nonce uint8,
