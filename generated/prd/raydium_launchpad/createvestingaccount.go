...
func (inst *CreateVestingAccount) SetAccounts(accounts []*ag_solanago.AccountMeta) error {
	inst.AccountMetaSlice = accounts
	return inst.Validate()
}

func (inst *CreateVestingAccount) SetRemainingAccounts(metas []*ag_solanago.AccountMeta) *CreateVestingAccount {
	inst.AccountMetaSlice = append(inst.AccountMetaSlice[0:5], metas...)
	return inst
}

func (inst *CreateVestingAccount) GetRemainingAccounts() []*ag_solanago.AccountMeta {
...
func NewCreateVestingAccountInstruction(
	...
	vestingRecord ag_solanago.PublicKey) *CreateVestingAccount {
...
// NewSimpleCreateVestingAccountInstruction declares a new CreateVestingAccount instruction with the provided parameters and accounts.
func NewSimpleCreateVestingAccountInstruction(
	// Parameters:
	share_amount uint64,
	// Accounts:
	creator ag_solanago.PublicKey,
	beneficiary ag_solanago.PublicKey,
	poolState ag_solanago.PublicKey) *CreateVestingAccount {
	vestingRecord := MustFindVestingRecordAddress(poolState, beneficiary)
	return NewCreateVestingAccountInstructionBuilder().
		SetShareAmount(share_amount).
		SetCreatorAccount(creator).
		SetBeneficiaryAccount(beneficiary).
