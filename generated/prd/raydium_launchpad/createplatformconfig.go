...
func (inst *CreatePlatformConfig) SetAccounts(accounts []*ag_solanago.AccountMeta) error {
	inst.AccountMetaSlice = accounts
	return inst.Validate()
}

func (inst *CreatePlatformConfig) SetRemainingAccounts(metas []*ag_solanago.AccountMeta) *CreatePlatformConfig {
	inst.AccountMetaSlice = append(inst.AccountMetaSlice[0:5], metas...)
	return inst
}

func (inst *CreatePlatformConfig) GetRemainingAccounts() []*ag_solanago.AccountMeta {
...
func NewCreatePlatformConfigInstruction(
	...
	platformConfig ag_solanago.PublicKey) *CreatePlatformConfig {
...
// NewSimpleCreatePlatformConfigInstruction declares a new CreatePlatformConfig instruction with the provided parameters and accounts.
func NewSimpleCreatePlatformConfigInstruction(
	// Parameters:
	platform_params PlatformParams,
	// Accounts:
	platformAdmin ag_solanago.PublicKey,
	platformFeeWallet ag_solanago.PublicKey,
	platformNftWallet ag_solanago.PublicKey) *CreatePlatformConfig {
