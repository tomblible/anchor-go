...
func NewInitializeInstructionBuilder() *Initialize {
	...
	nd.AccountMetaSlice[4] = ag_solanago.Meta(AuthorityPDA)
	nd.AccountMetaSlice[11] = ag_solanago.Meta(TokenProgram)
	nd.AccountMetaSlice[12] = ag_solanago.Meta(TokenProgram)
	nd.AccountMetaSlice[13] = ag_solanago.Meta(TokenMetadataProgram)
	nd.AccountMetaSlice[14] = ag_solanago.Meta(SystemProgram)
	nd.AccountMetaSlice[15] = ag_solanago.Meta(RentProgram)
...
func (obj Initialize) MarshalWithEncoder(encoder *ag_binary.Encoder) (err error) {
	...
	// Serialize `CurveParam` param:
	{
		...
		switch realvalue := obj.CurveParam.(type) {
...
func (obj *Initialize) UnmarshalWithDecoder(decoder *ag_binary.Decoder) (err error) {
	...
	// Deserialize `CurveParam`:
	{
		...
		switch tmp.Enum {
		case 0:
			obj.CurveParam = &tmp.Constant
		case 1:
			obj.CurveParam = &tmp.Fixed
		case 2:
			obj.CurveParam = &tmp.Linear
		default:
...
func NewInitializeInstruction(
	...
	metadataAccount ag_solanago.PublicKey) *Initialize {
...
func NewSimpleInitializeInstruction(
	...
	baseVault := MustFindBaseVaultAddress(poolState, baseMint)
	quoteVault := MustFindQuoteVaultAddress(poolState, quoteMint)
	return NewInitializeInstructionBuilder().
		SetBaseMintParam(base_mint_param).
		SetCurveParam(curve_param).
		SetVestingParam(vesting_param).
