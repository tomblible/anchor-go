...
func (inst *CollectFee) SetAccounts(accounts []*ag_solanago.AccountMeta) error {
	inst.AccountMetaSlice = accounts
	return inst.Validate()
}

func (inst *CollectFee) SetRemainingAccounts(metas []*ag_solanago.AccountMeta) *CollectFee {
	inst.AccountMetaSlice = append(inst.AccountMetaSlice[0:8], metas...)
	return inst
}

func (inst *CollectFee) GetRemainingAccounts() []*ag_solanago.AccountMeta {
...
func NewCollectFeeInstruction(
	...
	recipientTokenAccount ag_solanago.PublicKey) *CollectFee {
...
// NewSimpleCollectFeeInstruction declares a new CollectFee instruction with the provided parameters and accounts.
func NewSimpleCollectFeeInstruction(
	// Accounts:
	owner ag_solanago.PublicKey,
	poolState ag_solanago.PublicKey,
	globalConfig ag_solanago.PublicKey,
