...
func (inst *UpdateAdmin) SetAccounts(accounts []*ag_solanago.AccountMeta) error {
	inst.AccountMetaSlice = accounts
	return inst.Validate()
}

func (inst *UpdateAdmin) SetRemainingAccounts(metas []*ag_solanago.AccountMeta) *UpdateAdmin {
	inst.AccountMetaSlice = append(inst.AccountMetaSlice[0:5], metas...)
	return inst
}

func (inst *UpdateAdmin) GetRemainingAccounts() []*ag_solanago.AccountMeta {
