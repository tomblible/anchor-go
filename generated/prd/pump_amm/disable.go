...
func (inst *Disable) SetAccounts(accounts []*ag_solanago.AccountMeta) error {
	inst.AccountMetaSlice = accounts
	return inst.Validate()
}

func (inst *Disable) SetRemainingAccounts(metas []*ag_solanago.AccountMeta) *Disable {
	inst.AccountMetaSlice = append(inst.AccountMetaSlice[0:4], metas...)
	return inst
}

func (inst *Disable) GetRemainingAccounts() []*ag_solanago.AccountMeta {
...
func NewSimpleDisableInstruction(
	// Parameters:
	disable_create_pool bool,
	disable_deposit bool,
	disable_withdraw bool,
