...
func (inst *CreateConfig) SetAdminSetCoinCreatorAuthority(admin_set_coin_creator_authority ag_solanago.PublicKey) *CreateConfig {
...
func NewCreateConfigInstruction(
	...
	admin_set_coin_creator_authority ag_solanago.PublicKey) *CreateConfig {
