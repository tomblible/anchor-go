...
// SwapBaseOut is the `swap_base_out` instruction.
...
func (inst *SwapBaseOut) SetMaxAmountIn(max_amount_in uint64) *SwapBaseOut {
	inst.MaxAmountIn = &max_amount_in
	return inst
}

// SetAmountOut sets the "amount_out" parameter.
func (inst *SwapBaseOut) SetAmountOut(amount_out uint64) *SwapBaseOut {
...
func (inst *SwapBaseOut) SetAccounts(accounts []*ag_solanago.AccountMeta) error {
	inst.AccountMetaSlice = accounts
	return inst.Validate()
}

func (inst *SwapBaseOut) SetRemainingAccounts(metas []*ag_solanago.AccountMeta) *SwapBaseOut {
	inst.AccountMetaSlice = append(inst.AccountMetaSlice[0:18], metas...)
	return inst
}

func (inst *SwapBaseOut) GetRemainingAccounts() []*ag_solanago.AccountMeta {
...
// NewSimpleSwapBaseOutInstruction declares a new SwapBaseOut instruction with the provided parameters and accounts.
func NewSimpleSwapBaseOutInstruction(
	// Parameters:
	max_amount_in uint64,
	amount_out uint64,
	// Accounts:
