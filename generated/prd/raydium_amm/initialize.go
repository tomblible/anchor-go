...
type Initialize struct {
	...
	//
	// [11] = [WRITE] pool_withdraw_queue
	//
	// [12] = [WRITE] pool_target_orders_account
	//
	// [13] = [WRITE] user_lp_token_account
	//
...
// SetPoolTargetOrdersAccountAccount sets the "pool_target_orders_account" account.
...
// GetPoolTargetOrdersAccountAccount gets the "pool_target_orders_account" account.
			...
			programBranch.Child(ag_format.Instruction("Initialize")).
				...
				ParentFunc(func(instructionBranch ag_treeout.Branches) {
					...
					instructionBranch.Child("Accounts[len=18]").ParentFunc(func(accountsBranch ag_treeout.Branches) {
						...
						accountsBranch.Child(ag_format.Meta("pool_withdraw_queue", inst.AccountMetaSlice.Get(11)))
						accountsBranch.Child(ag_format.Meta("pool_target_orders_", inst.AccountMetaSlice.Get(12)))
						accountsBranch.Child(ag_format.Meta("     user_lp_token_", inst.AccountMetaSlice.Get(13)))
						accountsBranch.Child(ag_format.Meta("pool_temp_lp_token_", inst.AccountMetaSlice.Get(14)))
