...
func (inst *Sell) SetData(data TradeParams) *Sell {
	inst.Data = &data
	return inst
}

// SetSenderAccount sets the "sender" account.
func (inst *Sell) SetSenderAccount(sender ag_solanago.PublicKey) *Sell {
	inst.AccountMetaSlice[0] = ag_solanago.Meta(sender).WRITE().SIGNER()
	return inst
}

// GetSenderAccount gets the "sender" account.
func (inst *Sell) GetSenderAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(0)
}

// SetSenderTokenAccountAccount sets the "sender_token_account" account.
func (inst *Sell) SetSenderTokenAccountAccount(senderTokenAccount ag_solanago.PublicKey) *Sell {
...
func (inst *Sell) GetSenderTokenAccountAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(1)
}

// SetCurveAccountAccount sets the "curve_account" account.
func (inst *Sell) SetCurveAccountAccount(curveAccount ag_solanago.PublicKey) *Sell {
	inst.AccountMetaSlice[2] = ag_solanago.Meta(curveAccount).WRITE()
	return inst
}

// GetCurveAccountAccount gets the "curve_account" account.
func (inst *Sell) GetCurveAccountAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(2)
}

// SetCurveTokenAccountAccount sets the "curve_token_account" account.
func (inst *Sell) SetCurveTokenAccountAccount(curveTokenAccount ag_solanago.PublicKey) *Sell {
...
func (inst *Sell) GetCurveTokenAccountAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(3)
}

// SetDexFeeAccount sets the "dex_fee" account.
func (inst *Sell) SetDexFeeAccount(dexFee ag_solanago.PublicKey) *Sell {
	inst.AccountMetaSlice[4] = ag_solanago.Meta(dexFee).WRITE()
	return inst
}

// GetDexFeeAccount gets the "dex_fee" account.
func (inst *Sell) GetDexFeeAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(4)
}

// SetHelioFeeAccount sets the "helio_fee" account.
func (inst *Sell) SetHelioFeeAccount(helioFee ag_solanago.PublicKey) *Sell {
	inst.AccountMetaSlice[5] = ag_solanago.Meta(helioFee).WRITE()
	return inst
}

// GetHelioFeeAccount gets the "helio_fee" account.
func (inst *Sell) GetHelioFeeAccount() *ag_solanago.AccountMeta {
...
func (inst *Sell) SetConfigAccountAccount(configAccount ag_solanago.PublicKey) *Sell {
	inst.AccountMetaSlice[7] = ag_solanago.Meta(configAccount)
	return inst
}

// GetConfigAccountAccount gets the "config_account" account.
func (inst *Sell) GetConfigAccountAccount() *ag_solanago.AccountMeta {
