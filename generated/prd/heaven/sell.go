...
func (inst *Sell) SetTokenAProgramAccount(tokenAProgram ag_solanago.PublicKey) *Sell {
	inst.AccountMetaSlice[0] = ag_solanago.Meta(tokenAProgram)
	return inst
}

// GetTokenAProgramAccount gets the "token_a_program" account.
func (inst *Sell) GetTokenAProgramAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(0)
}

// SetTokenBProgramAccount sets the "token_b_program" account.
func (inst *Sell) SetTokenBProgramAccount(tokenBProgram ag_solanago.PublicKey) *Sell {
	inst.AccountMetaSlice[1] = ag_solanago.Meta(tokenBProgram)
	return inst
}

// GetTokenBProgramAccount gets the "token_b_program" account.
func (inst *Sell) GetTokenBProgramAccount() *ag_solanago.AccountMeta {
...
func (inst *Sell) SetLiquidityPoolStateAccount(liquidityPoolState ag_solanago.PublicKey) *Sell {
...
func (inst *Sell) GetLiquidityPoolStateAccount() *ag_solanago.AccountMeta {
...
// CHECK
func (inst *Sell) SetTokenAMintAccount(tokenAMint ag_solanago.PublicKey) *Sell {
...
// CHECK
func (inst *Sell) GetTokenAMintAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(6)
}

// SetTokenBMintAccount sets the "token_b_mint" account.
// CHECK
func (inst *Sell) SetTokenBMintAccount(tokenBMint ag_solanago.PublicKey) *Sell {
...
// CHECK
func (inst *Sell) GetTokenBMintAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(7)
}

// SetUserTokenAVaultAccount sets the "user_token_a_vault" account.
func (inst *Sell) SetUserTokenAVaultAccount(userTokenAVault ag_solanago.PublicKey) *Sell {
...
func (inst *Sell) GetUserTokenAVaultAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(8)
}

// SetUserTokenBVaultAccount sets the "user_token_b_vault" account.
func (inst *Sell) SetUserTokenBVaultAccount(userTokenBVault ag_solanago.PublicKey) *Sell {
...
// CHECK
func (inst *Sell) GetInstructionSysvarAccountInfoAccount() *ag_solanago.AccountMeta {
...
func (inst *Sell) SetPriceStateAccount(priceState ag_solanago.PublicKey) *Sell {
	inst.AccountMetaSlice[15] = ag_solanago.Meta(priceState)
	return inst
}

// GetPriceStateAccount gets the "price_state" account.
func (inst *Sell) GetPriceStateAccount() *ag_solanago.AccountMeta {
...
func NewSellInstruction(
	...
	protocolConfig ag_solanago.PublicKey) *Sell {
