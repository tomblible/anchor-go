...
func (inst *Swap2) SetParams(params SwapParameters2) *Swap2 {
	inst.Params = &params
	return inst
}

// SetPoolAuthorityAccount sets the "pool_authority" account.
func (inst *Swap2) SetPoolAuthorityAccount(poolAuthority ag_solanago.PublicKey) *Swap2 {
	inst.AccountMetaSlice[0] = ag_solanago.Meta(poolAuthority)
	return inst
}

// GetPoolAuthorityAccount gets the "pool_authority" account.
func (inst *Swap2) GetPoolAuthorityAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(0)
}

// SetConfigAccount sets the "config" account.
// config key
func (inst *Swap2) SetConfigAccount(config ag_solanago.PublicKey) *Swap2 {
...
// config key
func (inst *Swap2) GetConfigAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(1)
}

// SetPoolAccount sets the "pool" account.
// Pool account
func (inst *Swap2) SetPoolAccount(pool ag_solanago.PublicKey) *Swap2 {
...
// Pool account
func (inst *Swap2) GetPoolAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(2)
}

// SetInputTokenAccountAccount sets the "input_token_account" account.
// The user token account for input token
func (inst *Swap2) SetInputTokenAccountAccount(inputTokenAccount ag_solanago.PublicKey) *Swap2 {
...
// The user token account for input token
func (inst *Swap2) GetInputTokenAccountAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(3)
}

// SetOutputTokenAccountAccount sets the "output_token_account" account.
// The user token account for output token
func (inst *Swap2) SetOutputTokenAccountAccount(outputTokenAccount ag_solanago.PublicKey) *Swap2 {
...
// The user token account for output token
func (inst *Swap2) GetOutputTokenAccountAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(4)
}

// SetBaseVaultAccount sets the "base_vault" account.
// The vault token account for base token
func (inst *Swap2) SetBaseVaultAccount(baseVault ag_solanago.PublicKey) *Swap2 {
...
// The vault token account for base token
func (inst *Swap2) GetBaseVaultAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(5)
}

// SetQuoteVaultAccount sets the "quote_vault" account.
// The vault token account for quote token
func (inst *Swap2) SetQuoteVaultAccount(quoteVault ag_solanago.PublicKey) *Swap2 {
...
// The vault token account for quote token
func (inst *Swap2) GetQuoteVaultAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(6)
}

// SetBaseMintAccount sets the "base_mint" account.
// The mint of base token
func (inst *Swap2) SetBaseMintAccount(baseMint ag_solanago.PublicKey) *Swap2 {
...
// The mint of base token
func (inst *Swap2) GetBaseMintAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(7)
}

// SetQuoteMintAccount sets the "quote_mint" account.
// The mint of quote token
func (inst *Swap2) SetQuoteMintAccount(quoteMint ag_solanago.PublicKey) *Swap2 {
...
// The mint of quote token
func (inst *Swap2) GetQuoteMintAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(8)
}

// SetPayerAccount sets the "payer" account.
// The user performing the swap
func (inst *Swap2) SetPayerAccount(payer ag_solanago.PublicKey) *Swap2 {
...
// The user performing the swap
func (inst *Swap2) GetPayerAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(9)
}

// SetTokenBaseProgramAccount sets the "token_base_program" account.
// Token base program
func (inst *Swap2) SetTokenBaseProgramAccount(tokenBaseProgram ag_solanago.PublicKey) *Swap2 {
...
// Token base program
func (inst *Swap2) GetTokenBaseProgramAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(10)
}

// SetTokenQuoteProgramAccount sets the "token_quote_program" account.
// Token quote program
func (inst *Swap2) SetTokenQuoteProgramAccount(tokenQuoteProgram ag_solanago.PublicKey) *Swap2 {
...
// Token quote program
func (inst *Swap2) GetTokenQuoteProgramAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(11)
}

// SetReferralTokenAccountAccount sets the "referral_token_account" account.
// referral token account
func (inst *Swap2) SetReferralTokenAccountAccount(referralTokenAccount ag_solanago.PublicKey) *Swap2 {
...
// referral token account
func (inst *Swap2) GetReferralTokenAccountAccount() *ag_solanago.AccountMeta {
...
func NewSwap2Instruction(
	...
	referralTokenAccount ag_solanago.PublicKey) *Swap2 {
