...
func (inst *SetAuthority) SetAccounts(accounts []*ag_solanago.AccountMeta) error {
	inst.AccountMetaSlice = accounts
	return inst.Validate()
}

func (inst *SetAuthority) SetRemainingAccounts(metas []*ag_solanago.AccountMeta) *SetAuthority {
	inst.AccountMetaSlice = append(inst.AccountMetaSlice[0:2], metas...)
	return inst
}

func (inst *SetAuthority) GetRemainingAccounts() []*ag_solanago.AccountMeta {
			...
			programBranch.Child(ag_format.Instruction("SetAuthority")).
				...
				ParentFunc(func(instructionBranch ag_treeout.Branches) {
					...
					instructionBranch.Child("Accounts[len=2]").ParentFunc(func(accountsBranch ag_treeout.Branches) {
						accountsBranch.Child(ag_format.Meta("  subject", inst.AccountMetaSlice.Get(0)))
...
// NewSimpleSetAuthorityInstruction declares a new SetAuthority instruction with the provided parameters and accounts.
func NewSimpleSetAuthorityInstruction(
	// Parameters:
	authority_type AuthorityType,
	new_authority ag_solanago.PublicKey,
	// Accounts:
