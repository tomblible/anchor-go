...
func (inst *MintTo) SetAccounts(accounts []*ag_solanago.AccountMeta) error {
	inst.AccountMetaSlice = accounts
	return inst.Validate()
}

func (inst *MintTo) SetRemainingAccounts(metas []*ag_solanago.AccountMeta) *MintTo {
	inst.AccountMetaSlice = append(inst.AccountMetaSlice[0:3], metas...)
	return inst
}

func (inst *MintTo) GetRemainingAccounts() []*ag_solanago.AccountMeta {
...
// NewSimpleMintToInstruction declares a new MintTo instruction with the provided parameters and accounts.
func NewSimpleMintToInstruction(
	// Parameters:
	amount uint64,
	// Accounts:
	mint ag_solanago.PublicKey,
