...
func NewMetadataPointerExtensionInstructionBuilder() *MetadataPointerExtension {
	nd := &MetadataPointerExtension{
		AccountMetaSlice: make(ag_solanago.AccountMetaSlice, 0),
	}
	return nd
}

func (inst *MetadataPointerExtension) SetAccounts(accounts []*ag_solanago.AccountMeta) error {
	inst.AccountMetaSlice = accounts
	return inst.Validate()
}

func (inst *MetadataPointerExtension) SetRemainingAccounts(metas []*ag_solanago.AccountMeta) *MetadataPointerExtension {
	inst.AccountMetaSlice = append(inst.AccountMetaSlice[0:0], metas...)
	return inst
}

func (inst *MetadataPointerExtension) GetRemainingAccounts() []*ag_solanago.AccountMeta {
...
func (inst MetadataPointerExtension) Build() *Instruction {
	return &Instruction{BaseVariant: ag_binary.BaseVariant{
		Impl:   inst,
		TypeID: Instruction_MetadataPointerExtension,
	}}
}
...
func (inst *MetadataPointerExtension) EncodeToTree(parent ag_treeout.Branches) {
	parent.Child(ag_format.Program(ProgramName, ProgramID)).
		...
		ParentFunc(func(programBranch ag_treeout.Branches) {
			programBranch.Child(ag_format.Instruction("MetadataPointerExtension")).
				//
...
// NewMetadataPointerExtensionInstruction declares a new MetadataPointerExtension instruction with the provided parameters and accounts.
func NewMetadataPointerExtensionInstruction() *MetadataPointerExtension {
	return NewMetadataPointerExtensionInstructionBuilder()
}

// NewSimpleMetadataPointerExtensionInstruction declares a new MetadataPointerExtension instruction with the provided parameters and accounts.
func NewSimpleMetadataPointerExtensionInstruction() *MetadataPointerExtension {
	return NewMetadataPointerExtensionInstructionBuilder()
}
