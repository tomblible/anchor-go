...
func (inst *ApproveChecked) SetAccounts(accounts []*ag_solanago.AccountMeta) error {
	inst.AccountMetaSlice = accounts
	return inst.Validate()
}

func (inst *ApproveChecked) SetRemainingAccounts(metas []*ag_solanago.AccountMeta) *ApproveChecked {
	inst.AccountMetaSlice = append(inst.AccountMetaSlice[0:4], metas...)
	return inst
}

func (inst *ApproveChecked) GetRemainingAccounts() []*ag_solanago.AccountMeta {
...
// NewSimpleApproveCheckedInstruction declares a new ApproveChecked instruction with the provided parameters and accounts.
func NewSimpleApproveCheckedInstruction(
	// Parameters:
	amount uint64,
	decimals uint8,
	// Accounts:
