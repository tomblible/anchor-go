...
func (inst *TransferChecked) SetAccounts(accounts []*ag_solanago.AccountMeta) error {
	inst.AccountMetaSlice = accounts
	return inst.Validate()
}

func (inst *TransferChecked) SetRemainingAccounts(metas []*ag_solanago.AccountMeta) *TransferChecked {
	inst.AccountMetaSlice = append(inst.AccountMetaSlice[0:4], metas...)
	return inst
}

func (inst *TransferChecked) GetRemainingAccounts() []*ag_solanago.AccountMeta {
...
// NewSimpleTransferCheckedInstruction declares a new TransferChecked instruction with the provided parameters and accounts.
func NewSimpleTransferCheckedInstruction(
	// Parameters:
	amount uint64,
	decimals uint8,
	// Accounts:
