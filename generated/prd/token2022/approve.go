...
func (inst *Approve) SetAccounts(accounts []*ag_solanago.AccountMeta) error {
	inst.AccountMetaSlice = accounts
	return inst.Validate()
}

func (inst *Approve) SetRemainingAccounts(metas []*ag_solanago.AccountMeta) *Approve {
	inst.AccountMetaSlice = append(inst.AccountMetaSlice[0:3], metas...)
	return inst
}

func (inst *Approve) GetRemainingAccounts() []*ag_solanago.AccountMeta {
...
// NewSimpleApproveInstruction declares a new Approve instruction with the provided parameters and accounts.
func NewSimpleApproveInstruction(
	// Parameters:
	amount uint64,
	// Accounts:
	source ag_solanago.PublicKey,
