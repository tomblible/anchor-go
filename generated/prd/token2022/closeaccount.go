...
func (inst *CloseAccount) SetAccounts(accounts []*ag_solanago.AccountMeta) error {
	inst.AccountMetaSlice = accounts
	return inst.Validate()
}

func (inst *CloseAccount) SetRemainingAccounts(metas []*ag_solanago.AccountMeta) *CloseAccount {
	inst.AccountMetaSlice = append(inst.AccountMetaSlice[0:3], metas...)
	return inst
}

func (inst *CloseAccount) GetRemainingAccounts() []*ag_solanago.AccountMeta {
...
// NewSimpleCloseAccountInstruction declares a new CloseAccount instruction with the provided parameters and accounts.
func NewSimpleCloseAccountInstruction(
	// Accounts:
	account ag_solanago.PublicKey,
	destination ag_solanago.PublicKey,
	owner ag_solanago.PublicKey) *CloseAccount {
