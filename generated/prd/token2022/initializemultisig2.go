...
// The multisignature account to initialize.
func (inst *InitializeMultisig2) SetAccountAccount(account ag_solanago.PublicKey) *InitializeMultisig2 {
...
// The multisignature account to initialize.
func (inst *InitializeMultisig2) GetAccountAccount() *ag_solanago.AccountMeta {
...
func (inst *InitializeMultisig2) SetAccounts(accounts []*ag_solanago.AccountMeta) error {
	inst.AccountMetaSlice = accounts
	return inst.Validate()
}

func (inst *InitializeMultisig2) SetRemainingAccounts(metas []*ag_solanago.AccountMeta) *InitializeMultisig2 {
	inst.AccountMetaSlice = append(inst.AccountMetaSlice[0:2], metas...)
	return inst
}

func (inst *InitializeMultisig2) GetRemainingAccounts() []*ag_solanago.AccountMeta {
			...
			programBranch.Child(ag_format.Instruction("InitializeMultisig2")).
				...
				ParentFunc(func(instructionBranch ag_treeout.Branches) {
					...
					instructionBranch.Child("Accounts[len=2]").ParentFunc(func(accountsBranch ag_treeout.Branches) {
						...
						accountsBranch.Child(ag_format.Meta("signers", inst.AccountMetaSlice.Get(1)))
					})
				})
		})
}
...
// NewSimpleInitializeMultisig2Instruction declares a new InitializeMultisig2 instruction with the provided parameters and accounts.
func NewSimpleInitializeMultisig2Instruction(
	// Parameters:
	m uint8,
	// Accounts:
	account ag_solanago.PublicKey,
