...
func (inst *BurnChecked) SetAccounts(accounts []*ag_solanago.AccountMeta) error {
	inst.AccountMetaSlice = accounts
	return inst.Validate()
}

func (inst *BurnChecked) SetRemainingAccounts(metas []*ag_solanago.AccountMeta) *BurnChecked {
	inst.AccountMetaSlice = append(inst.AccountMetaSlice[0:3], metas...)
	return inst
}

func (inst *BurnChecked) GetRemainingAccounts() []*ag_solanago.AccountMeta {
...
// NewSimpleBurnCheckedInstruction declares a new BurnChecked instruction with the provided parameters and accounts.
func NewSimpleBurnCheckedInstruction(
	// Parameters:
	amount uint64,
	decimals uint8,
	// Accounts:
