...
func (inst *Burn) SetAccounts(accounts []*ag_solanago.AccountMeta) error {
	inst.AccountMetaSlice = accounts
	return inst.Validate()
}

func (inst *Burn) SetRemainingAccounts(metas []*ag_solanago.AccountMeta) *Burn {
	inst.AccountMetaSlice = append(inst.AccountMetaSlice[0:3], metas...)
	return inst
}

func (inst *Burn) GetRemainingAccounts() []*ag_solanago.AccountMeta {
...
// NewSimpleBurnInstruction declares a new Burn instruction with the provided parameters and accounts.
func NewSimpleBurnInstruction(
	// Parameters:
	amount uint64,
	// Accounts:
	source ag_solanago.PublicKey,
