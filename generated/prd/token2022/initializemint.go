...
func (inst *InitializeMint) SetAccounts(accounts []*ag_solanago.AccountMeta) error {
	inst.AccountMetaSlice = accounts
	return inst.Validate()
}

func (inst *InitializeMint) SetRemainingAccounts(metas []*ag_solanago.AccountMeta) *InitializeMint {
	inst.AccountMetaSlice = append(inst.AccountMetaSlice[0:2], metas...)
	return inst
}

func (inst *InitializeMint) GetRemainingAccounts() []*ag_solanago.AccountMeta {
...
// NewSimpleInitializeMintInstruction declares a new InitializeMint instruction with the provided parameters and accounts.
func NewSimpleInitializeMintInstruction(
	// Parameters:
	decimals uint8,
	mint_authority ag_solanago.PublicKey,
	freeze_authority ag_solanago.PublicKey,
