...
func (inst *AmountToUiAmount) SetRemainingAccounts(metas []*ag_solanago.AccountMeta) *AmountToUiAmount {
	inst.AccountMetaSlice = append(inst.AccountMetaSlice[0:1], metas...)
	return inst
}

func (inst *AmountToUiAmount) GetRemainingAccounts() []*ag_solanago.AccountMeta {
...
// NewSimpleAmountToUiAmountInstruction declares a new AmountToUiAmount instruction with the provided parameters and accounts.
func NewSimpleAmountToUiAmountInstruction(
	// Parameters:
	amount uint64,
	// Accounts:
	mint ag_solanago.PublicKey) *AmountToUiAmount {
