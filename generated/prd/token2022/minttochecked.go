...
func (inst *MintToChecked) SetAccounts(accounts []*ag_solanago.AccountMeta) error {
	inst.AccountMetaSlice = accounts
	return inst.Validate()
}

func (inst *MintToChecked) SetRemainingAccounts(metas []*ag_solanago.AccountMeta) *MintToChecked {
	inst.AccountMetaSlice = append(inst.AccountMetaSlice[0:3], metas...)
	return inst
}

func (inst *MintToChecked) GetRemainingAccounts() []*ag_solanago.AccountMeta {
...
// NewSimpleMintToCheckedInstruction declares a new MintToChecked instruction with the provided parameters and accounts.
func NewSimpleMintToCheckedInstruction(
	// Parameters:
	amount uint64,
	decimals uint8,
	// Accounts:
